...
class Part(Geometry):
	...
	def create_surfaces_from_revolve(self, feature):
		...
		plane1 = Plane(Vertex.from_xyz(global_axis_dir),
									 Vertex.from_xyz(global_axis_perp_dir1))  # , Vertex.from_xyz(global_axis_origo))
		plane2 = Plane(Vertex.from_xyz(global_axis_dir),
									 Vertex.from_xyz(global_axis_perp_dir2))  # , Vertex.from_xyz(global_axis_origo))
	...
	def deserialize_data(self, data):
		...
		self._specular = data.get('specular', 0.5)
		self._update_needed = True
