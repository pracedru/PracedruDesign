...
class KeyPoint(Point3d, ObservableObject):
	...
	def get_instance_x(self, instance_uid):
		if self._x_param is None:
			return self.x
		else:
			return self._x_param.get_instance_value(instance_uid)

	def get_instance_y(self, instance_uid):
		if self._y_param is None:
			return self.y
		else:
			return self._y_param.get_instance_value(instance_uid)

	def get_instance_z(self, instance_uid):
		if self._z_param is None:
			return self.z
		else:
			return self._z_param.get_instance_value(instance_uid)
